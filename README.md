...
size was 3 × 3 pixels.)(图1)。

实验二：请以自己 fine-tuning 后的架构进行 training，请描述你的 model，使用了那些 trick，
以及为什么这样的架构会有比较好的 performance (解释)。

备注：必须注意 trade-off between accuracy and time，务必在实验当中测试两者跑的时间，并说
明为何这样的 running time 对这样的 accuracy 是最佳组合。实验具体情形可以参考 template (图 2)。
```
| 图 1 | 图 2 |
| ---- | -------- |
| <img src="https://i.imgur.com/v4MKARf.png" width="330"> | <img src="https://i.imgur.com/8IXBE5Q.png" width="330"> |
