...
class Model:
    def __init__(self,
        ...
        self.loss_1, self.pred_1, self.acc_1, self.loss_2, self.pred_2, self.acc_2, self.loss_3, self.pred_3, self.acc_3 = self.forward(is_train=True)
    ...
    def forward(self, is_train):
        ...
        return loss_1, pred_1, acc_1, loss_2, pred_2, acc_2, loss_3, pred_3, acc_3